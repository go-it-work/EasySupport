...
namespace MRTK_HKSample
{
    ...
    public class TwoHandsRuler : MonoBehaviour
    {
        ...
        // Sucess boxes
        [SerializeField]
        private GameObject twohandsPlate;
        [SerializeField]
        private GameObject onehandPlate;
        [SerializeField]
        ...
        public GameObject TwoHandsPlate
        {
            get { return twohandsPlate; }
            set { twohandsPlate = value; }
        }

        public GameObject OneHandPlate
        {
            get { return onehandPlate; }
            set { onehandPlate = value; }
        }
        ...
        public void Record()
        {
            ...
            {
                recordedText.text = distanceText.text;
            }
        }
    }
}